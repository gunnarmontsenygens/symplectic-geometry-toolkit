function P_x2z_mtx = compute_P_x2z_3dof()
%==========================================================================
%
...
% (2025) is naturally constructed in canonical ordering:
%
...
%   - Spatial 3-DoF Hamiltonian systems only
%
% Author: G. Montseny
% Date: May 28, 2026
%
...
%==========================================================================
    ...
    P_x2z_mtx = compute_P_ij_ndof(6,4,5) * ...
                compute_P_ij_ndof(6,3,4) * ...
                compute_P_ij_ndof(6,2,4) ;
